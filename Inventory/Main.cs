...
namespace Inventory
{
    public class Main : Script
    {
        ...
        public static string SaveLocation = "Inventories";
        ...
        {
            SaveLocation = API.getResourceFolder() + Path.DirectorySeparatorChar + "Inventories";
            ...
            switch (eventName)
            {
                ...
                case "TakeItem":
                {
                    ...
                    if (added > 0)
                    {
                        ...
                        player.sendChatMessage($"Took {item.Name} x{added}.");
                    }
